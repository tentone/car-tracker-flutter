...
class Database {
  ...
  static void create() {
    ...
    // You can run select statements with PreparedStatement.select, or directly on the database:
    final ResultSet resultSet =
    db.select('SELECT * FROM artists WHERE name LIKE ?', ['The %']);

    // You can iterate on the result set in multiple ways to retrieve Row objects one by one.
